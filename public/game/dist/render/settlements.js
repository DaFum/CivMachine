...
function kindFor(index, count, settlementClass, stage, seed, allowed, distance) {
...
function buildSettlementStructures(civ, count, index, settlementClass, rank, stage, centerX, radius, globalIndex, scale, widthScale, heightScale, skylineBudget, allowed) {
    const structures = [];
...
export function settlementLayout(civ, worldWidth, height, snapshot) {
    ...
    for (let index = 0; index < sizes.length; index++) {
        ...
        const { structures, nextGlobalIndex } = buildSettlementStructures(civ, count, index, settlementClass, rank, stage, centerX, radius, globalIndex, scale, widthScale, heightScale, skylineBudget, allowed);
