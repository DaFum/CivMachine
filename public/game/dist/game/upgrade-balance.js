const MACHINE_OVERRIDES = {
    reality_lattice: { base_cost: 60, growth: 1.55, description: '+1 Containment per level, which slows Entropy in every era. +10 starting and maximum Reality Stability per level.' },
