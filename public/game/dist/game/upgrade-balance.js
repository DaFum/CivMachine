 ...
 */
const REALITY_LATTICE_LADDER = [60, 600, 1800, 4500, 11000, 26000, 60000, 140000];
/**
 ...
 */
const AWARENESS_SCRUBBER_LADDER = [520, 1650, 4200, 10000, 24000];
const SANITY_PROTOCOL_LADDER = [560, 1750, 4400, 10500, 25000];
const COSMIC_MUFFLING_LADDER = [520, 1650, 4200, 10000, 24000];
 ...
 */
const WIDE_LATTICE_LADDER = [5, 14, 34, 75, 155, 320];
const STABLE_CONSTANTS_LADDER = [6, 18, 45, 100, 210];
const UNIVERSE_LADDERS = {
 ...
 */
const DIRECTIVE_EFFECT_OVERRIDES = {
...
export function balancedDirectives(catalog) {
    return catalog.map(definition => {
...
//# sourceMappingURL=upgrade-balance.js.map