...
const reserveCostText = (entry) => fill(text().ui.app.reserveCost, { cost: fmt(entry.cost), currency: entry.currency.replaceAll('_', ' '), usesLeft: entry.usesLeft, maxUses: entry.maxUses });
