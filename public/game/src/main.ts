...
(document.querySelector('#reset-save') as HTMLButtonElement).addEventListener('click', () => {
  if (confirm('Erase the browser save and reset all Machine Insight, unlocks, and progress?')) engine.deleteSave();
});
